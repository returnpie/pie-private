  ...
  return (
    <div className="App">
      ...
      <body>
        ...
        <br />
        <br />
        (‘https://returnpie.com’이하 ‘returnpie.com’) 은(는) 다음의 목적을
        ...
        <br />
        <br />① (‘https://returnpie.com’이하 ‘returnpie.com’) 은(는)
        ...
        <p>
          ...
          <br />
          <br /> ① <em>('https://returnpie.com'이하 'returnpie.com')</em>은(는)
          정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및
          제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
        </p>
        ② <em>('https://returnpie.com')</em>은(는) 다음과 같이 개인정보를
        제3자에게 제공하고 있습니다.
        <br />
        <br />
        <p>
          <br />
          1. <br />- 개인정보를 제공받는 자 : <br />- 제공받는 자의 개인정보
          이용목적 : <br />- 제공받는 자의 보유.이용기간:{" "}
        </p>
        <br />
        <br />
        <p>
          ...
          <br />
          <br /> ① <em>('returnpie.com')</em>은(는) 원활한 개인정보 업무처리를
        ...
        <p>
          ① 정보주체는 returnpie(‘https://returnpie.com’이하 ‘returnpie.com) 에
        ...
        <p>
          1 회원가입
          <br />- 필수항목 : 이메일, 휴대전화번호, 로그인ID, 생년월일, 이름
          <br />- 선택항목 :{" "}
        </p>
        <br />
        <br />
        ...
        <p>
          <strong>
            7. 개인정보의 파기<em>('returnpie.com')</em>은(는) 원칙적으로
        ...
        <p>
          ① returnpie 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
          ...
          <br /> ① returnpie(‘https://returnpie.com’이하 ‘returnpie.com) 은(는)
          ...
          <p>
            ...
            직급 :대표
            <br />
            연락처 :01047397104, returnpie@icloud.com, <br />※ 개인정보 보호
            담당부서로 연결됩니다.
            <br /> <br />▶ 개인정보 보호 담당부서
            <br />
            부서명 :<br />
            담당자 :<br />
            연락처 :, , <br />② 정보주체께서는
            returnpie(‘https://returnpie.com’이하 ‘returnpie.com) 의 서비스(또는
            사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
            피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
            수 있습니다. returnpie(‘https://returnpie.com’이하 ‘returnpie.com)
          ...
          <p>
            <strong>
              11. 개인정보의 안전성 확보 조치 <em>('returnpie.com')</em>은(는)
